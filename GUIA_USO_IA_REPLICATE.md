...
2. Faça o primeiro aumento de resolução local.
3. Ajuste o tamanho final de impressão.
4. Confira o DPI efetivo mostrado no sistema.
5. Só use a IA externa se a definição ainda estiver insuficiente para a impressão.

## Regra prática

- Acima de 220 DPI: normalmente pode seguir sem IA.
- Entre 180 e 220 DPI: faixa intermediária; depende da arte e da distância de visualização.
- Abaixo de 180 DPI: a IA externa passa a ser fortemente recomendada.

## Quando usar apenas processamento local

- Imagens pequenas ou médias que já ficaram boas após o primeiro aumento.
- Casos em que o DPI final já esteja acima de 220.
...
- Fotos com muitos detalhes finos, como folhas, pelos, cabelos, penas e texturas delicadas.
- Situações em que a imagem ainda parece pixelada depois do primeiro aumento local.

## Regra para o fluxo do dia a dia
